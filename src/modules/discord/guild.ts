...
} from '../../utils/api/twitch-api-utils.ts';
import { listCutedogClipIds } from '../../utils/modules/discord/list-cutedog-clip-ids.ts';
import type { TwitchApi } from '../../api/twitch-api.ts';
import type { PersonalEmoteMatcherConstructor } from '../emote-matcher/emote-matcher-constructor.ts';
...
export const GUILD_ID_CUTEDOG = '251211223012474880' as const;
export const GENERAL_CHANNEL_ID_CUTEDOG = '251211223012474883' as const;
