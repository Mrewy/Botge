...
} from '../../utils/modules/message-builders/emote-cdn-url-to-emote-url.ts';
import { platformToString } from '../../utils/public/platform-to-string.ts';
import { booleanToString } from '../../utils/public/boolean-to-string.ts';
...
> {
  ...
  public static get messageBuilderType(): string {
    return EmoteMessageBuilder.#messageBuilderType;
  }
